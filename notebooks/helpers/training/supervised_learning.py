...
from helpers.eval.performance import AUPRC, f1_score, accuracy, eval_affect
from helpers.eval.complexity import all_in_one_train, all_in_one_test
    ...
    def _trainprocess():
        ...
        for epoch in range(total_epochs):
            ...
            if task == "classification":
                ...
                print(f"Valid Loss: {valloss.item():.4f} | Accuracy: {acc*100:.4f}%")
                ...
                print(f"Valid Loss: {valloss.item():.4f} | f1_micro: {f1_micro:.4f} | f1_macro: {f1_macro:.4f}")
                # print("Epoch "+str(epoch)+" valid loss: "+str(valloss) +
            ...
            if validtime:
                print("Valid Time: "+format_time(validendtime-validstarttime))
